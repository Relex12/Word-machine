...
* [`tokenization.py`](https://relex12.github.io/Word-machine/doc/tokenization.html)
...
```
usage: word-machine.py [-h] [-g NUM] [-a STR] [-d [FILE [FILE ...]]] [--dim NUM] [-c] [--plot PLOT] [-t] [-s SIZE] [-n] [-p PREFIX] [--length-range PERCENT] [--max-attempts NUM] [-b STR] [-e STR] [-w STR]
                       [-r NUM] [-v NUM] [--match-case] [--nb-limit NUM] [--disable-progress-bar] [--write FILE] [-o FILE] [--nb-columns NUM] [-l] [--alpha FILE] [-f] [--print-acronyms] [--print-plural LANG]
                       [--no-acronyms] [--no-plural LANG]
...
optional arguments:
  ...
  --plot PLOT           plot the 2D matrix as a diagram

generation arguments:
  -t, --token           use tokenization, slower but better results
...
anagram arguments:
  -b STR, --begin STR   first letters of the anagram (like --prefix)
  -e STR, --end STR     last letters of the anagram
  -w STR, --wildcard STR
